            ...
            <Row>
                <Form className="col-md-3 col-sm-8 p-5 col-centered text-left border" onSubmit={this.handle_submit}>
                    ...
                    <FormGroup>
                        ...
                        <Input pattern="\d*" type="number" required value={this.state.SharePrice} onChange={this.handle_asp} />
                        <small className="text-danger"></small>
                    </FormGroup>
                    <FormGroup>
                        <Label for="Shares">Shares</Label>
                        <Input pattern="\d*" type="number" required value={this.state.Share} onChange={this.handle_share} />
                        <small className="text-danger"></small>
                    </FormGroup>
